...
class EchoServer(TcpServer):
    @override
    async def _handle_client_connect(self, _client: TcpServer.Client) -> bool:
        return True

    @override
    async def _handle_client_disconnect(self, _client: TcpServer.Client) -> None:
        pass
...
class RejectConnectionServer(TcpServer):
    ...
    @override
    async def _handle_client_request(self, _client: TcpServer.Client) -> bool:
        return False
