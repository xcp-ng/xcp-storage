...
_LOG_TO_STDERR: Final = True
_LOG_TO_JOURNAL: Final = False

# `LOG_LOCAL2` is mapped to "/var/log/SMlog".
_LOG_SYSLOG_FACILITY: Final = logging.handlers.SysLogHandler.LOG_LOCAL2

_DEFAULT_LOGGER_NAME: Final = "core"
